<script setup>
  ...
  const getLeaveList = async (page = 0) => {
      ...
      console.log( getLeaveListResult)
      let pageInfo = {
        'from': getLeaveListResult.meta.from,
        'to': getLeaveListResult.meta.to,
        'total': getLeaveListResult.meta.total,
        'prev': getLeaveListResult.links.prev,
        'next': getLeaveListResult.links.next,
      }
